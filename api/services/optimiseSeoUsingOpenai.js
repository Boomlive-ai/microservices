  ...
  **Examples of Boomlive Titles**:
  ...
  const optimizeSeoUsingOpenAI = async (reqBody) => {
    const { headline, description, articleText, articlePreviewUrl, articleType, articleLanguage, focusKeywords } =
      reqBody;
      ...
      else if (articlePreviewUrl) {
        articleContent = await fetchArticleContent(articlePreviewUrl);
      }
